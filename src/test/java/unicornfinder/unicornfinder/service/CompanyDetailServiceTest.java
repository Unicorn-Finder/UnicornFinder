...
class CompanyDetailServiceTest {
    ...
    void 회사등록() throws Exception{
        //given
        Company company = Company.createCompany("우아한 형제들", "배달의 민족", 1000000000, Round.SERIES_E, "delivery", 500, Location.SEOUL_SONGPA);
        //when
    ...
    void 회사상세수정() {
        ...
        Long createId = companyService.create(company);
        //when
        companyDetailService.updateCompanyDetail(company.getCompanyDetail().getId(), "www.bm.com", "맥북 지원", "기술 이사 김영한","서울특별시 송파구 방이2동 위례성대로 2");
        //then
